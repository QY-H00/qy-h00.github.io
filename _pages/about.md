...
I am a third-year PhD student at the School of Computing, [National University of Singapore](https://nus.edu.sg/), where I am fortunate to be advised by **Professor [Angela Yao](https://www.comp.nus.edu.sg/~ayao/)**. I'm currently also a research intern at **[NVIDIA Efficient AI](https://research.nvidia.com/labs/eai/)** supervised by **Dr.Yuyang Zhao** and **Professor Song Han**. Previously, I am graduated in **Turing Programme** with Highest Distinction in Computer Science from the same faculty. My research is centered on developing **efficient and controllable visual-centric generative models**. I am particularly interested in understanding and modeling visual signals, as they are easy to obtain and can serve as observations of the real world with minimal inductive bias.
